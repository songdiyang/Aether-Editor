...
pub fn build_theme_mapping() -> HashMap<String, String> {
    ...
    let captures = [
        ...
        "class", "class.definition", "interface", "enum", "struct", "union",
        "function", "function.builtin", "function.macro", "function.definition",
        "method", "method.definition", "constructor", "call",
        "property", "property.definition", "field",
        "keyword", "keyword.conditional", "keyword.repeat", "keyword.return",
        "keyword.import", "keyword.exception", "keyword.operator", "keyword.directive",
        "keyword.function", "keyword.type", "keyword.storage", "keyword.modifier",
        "operator", "arithmetic", "logical", "comparison", "assignment",
        "comment", "comment.line", "comment.block", "comment.documentation", "doc",
        "string", "string.special", "string.escape", "string.regexp", "character",
        "number", "float", "integer", "boolean",
        "tag", "tag.builtin", "tag.delimiter", "attribute",
        "punctuation", "punctuation.delimiter", "punctuation.bracket", "punctuation.special",
        "label", "lifetime", "macro", "include", "exception",
    ];
    
    for capture in &captures {
        map.insert(capture.to_string(), capture_to_textmate_scope(capture).to_string());
    }
